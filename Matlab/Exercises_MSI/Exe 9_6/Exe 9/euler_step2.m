function [ x_next ] = euler_step2(deltaT,x0,u,param)
...
x_next_dummy(1,2)=x0(1,2);
x_next_dummy(1,3)=x0(1,3);
for a= 1:steps;
   x_next_dummy =x_next_dummy + robot_ode2(steps,x_next_dummy,u(a,:),param); 
end
x_next=x_next_dummy;
